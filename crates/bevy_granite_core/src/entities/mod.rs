...
pub fn add_ignore_serialize_to_bevy_types(type_registry: &mut App) {
    ...
    type_registry.register_type_data::<bevy::camera::primitives::Frustum, EditorIgnore>();
    type_registry.register_type_data::<bevy::camera::visibility::VisibleEntities, EditorIgnore>();
}
