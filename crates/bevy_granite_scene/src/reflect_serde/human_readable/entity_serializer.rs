...
use crate::{
    ...
    reflect_serde::{ComponentSerializeError, human_readable::ComponentSerializer},
    scene::{Chapters, SceneFormatWright, SceneFormatWrightDyn},
};
use crate::{reflect_serde::pure_reflect::serialize_with_reflect, scene::EntityMetaData};
...
impl<'a, W: std::fmt::Write> EntitySerializer<'a, W> {
    pub fn serialize_entity(&mut self, entity: Entity, world: &World) -> Result<()> {
        ...
        pwriteln!(self.stream, "{}":self.indent, Chapters::Components)?;
